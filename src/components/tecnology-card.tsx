...
export function TecnologyCard(props: tecnology) {
    ...
    return (
        <div className="w-52 h-80 flex justify-center items-center rounded-xl border-2 opacity-30 hover:opacity-90" style={{ borderColor: props.color || '#000', boxShadow: '1px 1px 15px 1px' + props.color }}>
            <div>
